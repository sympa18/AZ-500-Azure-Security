...
1. From the lab virtual machine, start another instance of Microsoft Edge, browse to the GitHub Azure QuickStart Templates page at  [**https://github.com/Azure/azure-quickstart-templates/active-directory-new-domain**](https://github.com/Azure/azure-quickstart-templates/tree/master/active-directory-new-domain).
